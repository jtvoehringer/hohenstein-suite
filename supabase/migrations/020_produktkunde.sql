-- 020: Produktkunde auf Firmen und Kontakten
-- Toggle „Produktkunde" + Mehrfachauswahl der Produkte (software:112, Webpage, Weinshop)
-- mit je einer Kundennummer im jeweiligen Produktsystem.
-- produkte: JSON-Array [{ "produkt": "software112" | "webpage" | "weinshop", "kundennummer": "…" | null }]
-- Idempotent.
