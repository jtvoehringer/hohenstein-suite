-- 017: Anlagenverzeichnis ─ Anlagevermögen für E&A-Rechnung und Reporting.
-- Lineare AfA mit Halbjahresregel (Anschaffung im 2. Halbjahr → halbe Jahres-AfA
-- im ersten Jahr), Sofortabschreibung für geringwertige Wirtschaftsgüter,
-- Abgang mit Datum/Erlös. Berechnung in src/lib/ea/anlagen.ts.
